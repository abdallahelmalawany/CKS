#!/bin/bash
# ============================================================
# validate-question.sh - Run validation for a CKS practice question
#
# Usage:
...
if [[ $# -lt 1 ]]; then
  ...
  echo ""
  echo "Examples:"
  echo "  scripts/validate-question.sh 5                                  # validate Question 5"
  echo "  scripts/validate-question.sh \"Question-5-Container-SecurityContext\"  # same, using directory name"
...
if [[ "$INPUT" == "all" ]]; then
  echo -e "${CYAN}+==========================================================+${NC}"
  echo -e "${CYAN}|        CKS Practice Questions - Full Validation         |${NC}"
  echo -e "${CYAN}+==========================================================+${NC}"
