#!/bin/bash
# ============================================================
# cleanup-question.sh -- Run cleanup for a CKS practice question
#
# Usage:
#   scripts/cleanup-question.sh 5
#   scripts/cleanup-question.sh "Question-5-Container-SecurityContext"
...
if [[ $# -lt 1 ]]; then
  ...
  echo "  scripts/cleanup-question.sh Question-5-Container-SecurityContext"
